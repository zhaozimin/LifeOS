/**
 * [INPUT]: 依赖 ECharts 5 按需组件、主题派生桥、主题 store 与 ResizeObserver。
 * [OUTPUT]: 对外提供随主题重建、随容器缩放并支持点击事件的 EChart 壳。
 * [POS]: components/charts 的唯一渲染边界；统计页只提供 option，不直接管理 ECharts 实例。
